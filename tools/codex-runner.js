...
// Adjusted for current codex CLI: use --full-auto to avoid approvals and set sandbox to workspace-write, and specify model.
const CODEx_ARGS_BASE = ["exec","--full-auto","--sandbox","workspace-write","--model","gpt-5"];
...
(async function main(){
  console.log("[codex-runner] start");
