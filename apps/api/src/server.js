...
import { mentorsLbCache, mentorsRankCache, scheduleMentorCacheMaintenance } from './cache/mentorCaches';
import { initRedisIfEnabled } from './cache/redisAdapter';
import { leaderboardCache, trustAroundCache, dailyTrustCache, scheduleTrustCacheMaintenance } from './cache/trustCaches';
...
import contractRoutes from './http/routes/contract';
import marketplaceRoutes from './http/routes/marketplace';
import mentorRoutes from './http/routes/mentor';
import reputationRoutes from './http/routes/reputation';
import roleRoutes from './http/routes/role';
import userRoutes from './http/routes/user';
import { httpRequestDuration, getPercentiles } from './metrics/latencyMetrics';
import { idempotencyMiddleware } from './middleware/idempotency';
import { leaderboardHeader } from './middleware/leaderboardHeader';
import { socketAuth } from './middleware/socketAuth';
import { initBlacklist } from './security/tokenBlacklist';
import { scheduleEconomySinkIfEnabled } from './services/economyService';
import { rehydrateQueues } from './services/mentorService';
import { scheduleDecayIfEnabled } from './services/reputationDecayService';
import { registerChatNamespace } from './sockets/chatSocket';
